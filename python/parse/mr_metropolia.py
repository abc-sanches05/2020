...
def pgsql_insert(lstapart):
    ...
    cursor = conn.cursor()
    cursor.execute('INSERT INTO mr_metropolia ( apart, price, price_m, date, hull, floor, size, finish) VALUES (%s, %s, %s, CURRENT_DATE,%s, %s, %s, %s)',
...
all_apart = pages(
    'https://www.mr-group.ru/catalog/apartments/?project=42&type=12&min_price=&max_price=')
